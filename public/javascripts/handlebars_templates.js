...
this["JST"]["album"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a href=\""
    ...
    + "</h3></figcaption><a class=\"button\" href=\"#\">Add to Cart</a><form action=\"albums\" method=\"post\"><input class=\"hidden\" name=\"id\" value=\""
...
this["JST"]["cart"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=items><ul>"
    ...
    + "</ul><h2>$"
    + container.escapeExpression(((helper = (helper = helpers.total_value || (depth0 != null ? depth0.total_value : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"total_value","hash":{},"data":data}) : helper)))
    + "</h2></div>";
  ...
  return "<li data-id=\""
    ...
    + "<span>$"
    + alias4(((helper = (helper = helpers.unit_price || (depth0 != null ? depth0.unit_price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"unit_price","hash":{},"data":data}) : helper)))
    + "</span></li>";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : {};

  return "<label for=\"cart_toggle\">"
    + container.escapeExpression(((helper = (helper = helpers.total_items || (depth0 != null ? depth0.total_items : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"total_items","hash":{},"data":data}) : helper)))
    + " items</label><input class=\"hidden\" type=\"checkbox\" id=\"cart_toggle\">"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.items_present : depth0),(depth0 != null ? depth0.items : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
